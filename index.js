 ...
 * @Version: 2.0
 * @Autor: liuhongbin
 * @Date: 2020-07-02 10:12:15
 * @LastEditors: liuhongbin
 * @LastEditTime: 2021-09-09 14:10:35
 */
...
http.createServer(async (req, res) => {
    ...
    if (req.method === 'POST' && req.url === '/') {
        ...
        // 拉取仓库最新代码
        execSync(`git clone https://github.com/notAugust/${data.repository.name}.git ${projectDir}`, {
            stdio: 'inherit',
        })
        ...
        // // 拉取 docker 镜像
        // execSync(`docker pull notAugust/docker-test-image:latest`, {
        //     stdio: 'inherit',
        //     cwd: projectDir
        // })
